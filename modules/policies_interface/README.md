...
| lacp | Create LACP Interface Policies. | <pre>map(object({<br>    annotation  = optional(string)<br>    ctrl        = optional(list(string))<br>    description = optional(string)<br>    max_links   = optional(number)<br>    min_links   = optional(number)<br>    name        = optional(string)<br>    name_alias  = optional(string)<br>    mode        = optional(string)<br>  }))</pre> | <pre>{<br>  "default": {<br>    "annotation": "",<br>    "ctrl": [<br>      "fast-sel-hot-stdby",<br>      "graceful-conv",<br>      "susp-individual"<br>    ],<br>    "description": "",<br>    "max_links": 16,<br>    "min_links": 1,<br>    "mode": "active",<br>    "name": "lacp_active",<br>    "name_alias": ""<br>  }<br>}</pre> | no |
