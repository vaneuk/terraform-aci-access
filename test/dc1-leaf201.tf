...
module "dc1-leaf201_interface_blocks" {
  ...
  port_block = {
    "Eth1-01" = {
      ...
      interface_selector = module.dc1-leaf201_interface_selectors.interface_selectors["Eth1-01"]
      name               = "Eth1-01"
    ...
    "Eth1-02" = {
      ...
      interface_selector = module.dc1-leaf201_interface_selectors.interface_selectors["Eth1-02"]
      name               = "Eth1-02"
      port_from          = 2
      port_to            = 2
    }
    "Eth1-49" = {
      ...
      interface_selector = module.dc1-leaf201_interface_selectors.interface_selectors["Eth1-49"]
      name               = "Eth1-49"
      port_from          = 49
      port_to            = 49
    }
...
module "dc1-leaf201_interface_sub_blocks" {
  ...
  port_block_sub = {
    "Eth1-49-1" = {
      ...
      interface_selector = module.dc1-leaf201_interface_selectors.interface_selectors["Eth1-49-1"]
      name               = "Eth1-49-1"
      port_from          = 49
      port_to            = 49
    ...
    "Eth1-49-2" = {
      description        = "Connection to endpointzyx"
      interface_selector = module.dc1-leaf201_interface_selectors.interface_selectors["Eth1-49-2"]
      name               = "Eth1-49-2"
      port_from          = 49
      port_to            = 49
      sub_port_from      = 2
